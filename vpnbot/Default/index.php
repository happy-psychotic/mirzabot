...
if (($user['step'] ?? '') !== 'searchservicereseller') {
    ...
    if ($directLinkUsername !== '') {
        if (in_array($from_id, $admin_ids)) {
            // Admin sent a config link — forward to full service management flow
            $text = $directLinkUsername;
            $user['step'] = 'searchservicereseller';
            // fall through to admin.php searchservicereseller handler
        } else {
